...
export function run(program, runSettings, userData = {}) {
	...
	return new Promise(function(resolve) {
		...
		settings.cursorelement.addEventListener('pointermove', e => {
			const targetRec = settings.element.getBoundingClientRect()
			const scaleX = targetRec.width / window.innerWidth
			const scaleY = targetRec.height / window.innerHeight
			pointer.x = (e.clientX) * scaleX
			pointer.y = (e.clientY) * scaleY
