        <section class="info workexamp">
            <div class="row">
                ...
                <div class="col-3 med-col-12">
                    <h2><span class="indicator num-1">N<span>o</span> 1</span> Selected work</h2>
                </div>
                <div class="col-9  med-col-12 gallery">
                    <div class="row">
        ...
        <section class="info aboutcarl">
            <div class="row">
                <div class="col-3 med-col-12">
                    <h2><span class="indicator num-1">N<span>o</span> 2</span> About</h2>
                </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-9">
                                    ...
                                    <h3>Availability</h3>
                                    <p>If you have a project that you think I would be suited to, <a href="mailto:hi@carlfairclough.me">contact me</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
